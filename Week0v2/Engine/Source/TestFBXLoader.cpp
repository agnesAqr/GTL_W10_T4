...
FSkeletalMeshRenderData* TestFBXLoader::ParseFBX(const FString& FilePath, const bool bIsAbsolutePath)
{
...
void TestFBXLoader::ExtractFBXMeshData(const FbxScene* Scene, FSkeletalMeshRenderData* MeshData, FRefSkeletal* RefSkeletal, TMap<FString, FbxNode*>& OutNodeMap)
{
...
void TestFBXLoader::ExtractMeshFromNode(FbxNode* Node, FSkeletalMeshRenderData* MeshData, FRefSkeletal* RefSkeletal, TMap<FString, FbxNode*>& OutNodeMap)
{
    if (Node != nullptr)
    {
...
UAnimSequence* TestFBXLoader::CreateAnimationSequence(const FString& FilePath)
{
    ParseFBX(FilePath);
...
UAnimSequence* TestFBXLoader::GetAnimationSequence(const FString& FilePath)
{
...
UAnimDataModel* TestFBXLoader::GetAnimDataModel(const FString& FilePath)
{
...
void TestFBXLoader::DebugWriteAnimationModel(const UAnimDataModel* AnimModel)
{
    if (!AnimModel)
    {
...
bool TestFBXLoader::ImportFBX(const FString& FilePath)
{
